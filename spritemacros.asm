...
EnemyProjectile1RightAnim: MACRO
	xor a
	SpriteAnimStart SPRITE_ENEMY_PROJECTILE1, ENEMY_PROJECTILE1_ANIM, ENEMY_PROJECTILE_ANIM_START, ENEMY_PROJECTILE_ANIM_END, PLAYER_PROJECTILE_ANIM_RIGHT
	ENDM
	
EnemyProjectile1LeftAnim: MACRO
	ld a, 1
	SpriteAnimStart SPRITE_ENEMY_PROJECTILE1, ENEMY_PROJECTILE1_ANIM, ENEMY_PROJECTILE_ANIM_START, ENEMY_PROJECTILE_ANIM_END, PLAYER_PROJECTILE_ANIM_LEFT
	ENDM
	
EnemyProjectile2RightAnim: MACRO
	xor a
	SpriteAnimStart SPRITE_ENEMY_PROJECTILE2, ENEMY_PROJECTILE2_ANIM, ENEMY_PROJECTILE_ANIM_START, ENEMY_PROJECTILE_ANIM_END, PLAYER_PROJECTILE_ANIM_RIGHT
	ENDM
	
EnemyProjectile2LeftAnim: MACRO
	ld a, 1
	SpriteAnimStart SPRITE_ENEMY_PROJECTILE2, ENEMY_PROJECTILE2_ANIM, ENEMY_PROJECTILE_ANIM_START, ENEMY_PROJECTILE_ANIM_END, PLAYER_PROJECTILE_ANIM_LEFT
	ENDM
