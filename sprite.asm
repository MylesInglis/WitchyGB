...
MONK_ANIM_IDLE EQU 0
MONK_ANIM_WALK EQU 1
MONK_ANIM_JUMP EQU 2
MONK_ANIM_FIRE EQU 3

MONK_ANIM_IDLE_START EQU 88
MONK_ANIM_IDLE_END EQU 88

MONK_ANIM_WALK_START EQU 88
MONK_ANIM_WALK_END EQU 115

MONK_ANIM_FIRE_START EQU 124
MONK_ANIM_FIRE_END EQU 124

MONK_ANIM_JUMP_START EQU 133
MONK_ANIM_JUMP_END EQU 133

ENEMY_PROJECTILE_ANIM_START EQU 142
ENEMY_PROJECTILE_ANIM_END EQU 142
...
SPRITE_ENEMY1 : DS METASPRITE_STRUCT_SIZE
ENEMY1_ANIM : DS ANIM_STRUCT_SIZE
SPRITE_ENEMY_PROJECTILE1 : DS METASPRITE_STRUCT_SIZE
SPRITE_ENEMY_PROJECTILE2 : DS METASPRITE_STRUCT_SIZE
ENEMY_PROJECTILE1_ANIM : DS ANIM_STRUCT_SIZE
ENEMY_PROJECTILE2_ANIM : DS ANIM_STRUCT_SIZE
...
SpriteInitAll:
	...
	SpriteInit SPRITE_ENEMY1, ENEMY1_ANIM, 130, 130, 3, 3, MONK_ANIM_IDLE_START
	SpriteInit SPRITE_ENEMY_PROJECTILE1, ENEMY_PROJECTILE1_ANIM, 100, 100, 1, 1, ENEMY_PROJECTILE_ANIM_START
	SpriteInit SPRITE_ENEMY_PROJECTILE2, ENEMY_PROJECTILE2_ANIM, 120, 120, 1, 1, ENEMY_PROJECTILE_ANIM_START
...
SpriteUpdateAll:
	...
	SpriteUpdate SPRITE_ENEMY_PROJECTILE1, OAM_ENEMY_PROJECTILE1
	SpriteUpdate SPRITE_ENEMY_PROJECTILE2, OAM_ENEMY_PROJECTILE2
	ld a, [SPRITE_ENEMY1 + METASPRITE_Y]
	or a
	jp z, .enemy2
	SpriteUpdate SPRITE_ENEMY1, OAM_ENEMY1
.enemy2
	ret
...
SpriteAnimAll:
	...
	or a
	jp z, .enemy2
	SpriteAnim ENEMY1_ANIM, SPRITE_ENEMY1
.enemy2
	ret
...
SpriteMoveAll:
	...
	LoadBCWithDE
	SpriteMove SPRITE_ENEMY_PROJECTILE1
	LoadBCWithDE
	SpriteMove SPRITE_ENEMY_PROJECTILE2
	LoadBCWithDE
	ld a, [SPRITE_ENEMY1 + METASPRITE_Y]
	or a
	jp z, .enemy2
	SpriteMove SPRITE_ENEMY1
.enemy2
	pop de
	ret
