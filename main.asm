...
Main:
	...
	call PlayerAnim
	call EnemyActAll
	UpdateProjectiles PLAYER_VARS + PLAYER_PROJECTILE1_LIFE, PLAYER_PROJECTILE1_ANIM, PLAYER_PROJECTILE2_ANIM, SPRITE_PLAYER_PROJECTILE1, SPRITE_PLAYER_PROJECTILE2, PROJECTILE_SPEED, PLAYER_VARS + PLAYER_PROJECTILE2_LIFE
	UpdateProjectiles ENEMY_PROJECTILE1_LIFE, ENEMY_PROJECTILE1_ANIM, ENEMY_PROJECTILE2_ANIM, SPRITE_ENEMY_PROJECTILE1, SPRITE_ENEMY_PROJECTILE2, ENEMY_PROJECTILE_SPEED, ENEMY_PROJECTILE2_LIFE
	call CameraFollow
	call SpriteAnimAll
