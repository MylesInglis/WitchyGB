...
.pulse1mus
	...
	jr z, .pulse2sfx
.aud1d
	CheckChannel [rAUD1LEN], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE1_D], [GYAL_OUT_BUF + GYAL_OUT_PULSE1_D], .aud1v
.aud1v
	CheckChannel [rAUD1ENV], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE1_V], [GYAL_OUT_BUF + GYAL_OUT_PULSE1_V], .aud1l
.aud1l
	CheckChannel [rAUD1LOW], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE1_L], [GYAL_OUT_BUF + GYAL_OUT_PULSE1_L], .aud1h
.aud1h
	CheckChannel [rAUD1HIGH], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE1_H], [GYAL_OUT_BUF + GYAL_OUT_PULSE1_H], .aud2d
.pulse2sfx
.aud2d
	CheckAllSFX rAUD2LEN, GYAL_OUT_PULSE2_D, .aud2v
	CheckChannel [rAUD2LEN], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE2_D], [GYAL_OUT_BUF + GYAL_OUT_PULSE2_D], .aud2v
.aud2v
	CheckAllSFX rAUD2ENV, GYAL_OUT_PULSE2_V, .aud2l
	CheckChannel [rAUD2ENV], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE2_V], [GYAL_OUT_BUF + GYAL_OUT_PULSE2_V], .aud2l
.aud2l
	CheckAllSFX rAUD2LOW, GYAL_OUT_PULSE2_L, .aud2h
	CheckChannel [rAUD2LOW], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE2_L], [GYAL_OUT_BUF + GYAL_OUT_PULSE2_L], .aud2h
.aud2h
	CheckAllSFX rAUD2HIGH, GYAL_OUT_PULSE2_H, .aud3len
	CheckChannel [rAUD2HIGH], [GYAL_OUT_FLAGS + GYAL_OUT_PULSE2_H], [GYAL_OUT_BUF + GYAL_OUT_PULSE2_H], .aud3len
.aud3len
	CheckAllSFX rAUD3LEN, GYAL_OUT_WAVE_LEN, .aud3v
	CheckChannel [rAUD3LEN], [GYAL_OUT_FLAGS + GYAL_OUT_WAVE_LEN], [GYAL_OUT_BUF + GYAL_OUT_WAVE_LEN], .aud3v
.aud3v
	CheckAllSFX rAUD3LEVEL, GYAL_OUT_WAVE_V, .aud3l
	CheckChannel [rAUD3LEVEL], [GYAL_OUT_FLAGS + GYAL_OUT_WAVE_V], [GYAL_OUT_BUF + GYAL_OUT_WAVE_V], .aud3l
.aud3l
	CheckAllSFX rAUD3LOW, GYAL_OUT_WAVE_L, .aud3h
	CheckChannel [rAUD3LOW], [GYAL_OUT_FLAGS + GYAL_OUT_WAVE_L], [GYAL_OUT_BUF + GYAL_OUT_WAVE_L], .aud3h
.aud3h
	CheckAllSFX rAUD3HIGH, GYAL_OUT_WAVE_H, .aud4len
	CheckChannel [rAUD3HIGH], [GYAL_OUT_FLAGS + GYAL_OUT_WAVE_H], [GYAL_OUT_BUF + GYAL_OUT_WAVE_H], .aud4len
.aud4len
	CheckAllSFX rAUD4LEN, GYAL_OUT_NOISE_LEN, .aud4v
	CheckChannel [rAUD4LEN], [GYAL_OUT_FLAGS + GYAL_OUT_NOISE_LEN], [GYAL_OUT_BUF + GYAL_OUT_NOISE_LEN], .aud4v
.aud4v
	CheckAllSFX rAUD4ENV, GYAL_OUT_NOISE_V, .aud4s
	CheckChannel [rAUD4ENV], [GYAL_OUT_FLAGS + GYAL_OUT_NOISE_V], [GYAL_OUT_BUF + GYAL_OUT_NOISE_V], .aud4s
.aud4s
	CheckAllSFX rAUD4POLY, GYAL_OUT_NOISE_S, .aud4t
	CheckChannel [rAUD4POLY], [GYAL_OUT_FLAGS + GYAL_OUT_NOISE_S], [GYAL_OUT_BUF + GYAL_OUT_NOISE_S], .aud4t
.aud4t
	CheckAllSFX rAUD4GO, GYAL_OUT_NOISE_T, .end
	CheckChannel [rAUD4GO], [GYAL_OUT_FLAGS + GYAL_OUT_NOISE_T], [GYAL_OUT_BUF + GYAL_OUT_NOISE_T], .end
.end
	ret
